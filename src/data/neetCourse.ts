...
export const courseBenefits: Benefit[] = [
  ...
  { id: 9, icon: Target, title: "Weekly Assessment Growth Report", description: "Weekly assessments with detailed performance analytics, progress charts, and actionable study recommendations." },
  { id: 10, icon: User, title: "Post-NEET Counselling & Guidance", description: "One-on-one counselling for college selection, admission strategies, application support, and career planning after NEET." },
];
